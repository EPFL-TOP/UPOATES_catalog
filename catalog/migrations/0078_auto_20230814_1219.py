...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('catalog', '0077_rename_experimentaldata_experimentaldataset'),
    ]
    ...
    operations = [
        migrations.AddField(
            ...
            name='experiment',
            field=models.ForeignKey(default='', help_text='Select experimental datasets for this experiment', null=True, on_delete=django.db.models.deletion.SET_DEFAULT, to='catalog.experiment'),
        ),
