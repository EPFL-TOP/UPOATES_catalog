...
class Injection(models.Model):
    ...
    slim_id             = models.CharField(blank=True, max_length=50, help_text="SLIMs ID")
...
class ExperimentalCondition(models.Model):
    ...
    comments   = models.TextField(blank=True, max_length=2000,  default='', help_text="Enter comments if any")
    fixation   = models.ForeignKey(Fixation, blank=True, null=True, default='', on_delete=models.CASCADE)
    def __str__(self):
        """String for representing the Model object (in Admin site etc.)"""
        try:
