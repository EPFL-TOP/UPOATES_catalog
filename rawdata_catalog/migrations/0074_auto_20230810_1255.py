...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('rawdata_catalog', '0073_delete_bookinstance'),
    ]
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name='injection',
            field=models.ManyToManyField(blank=True, help_text='Select injection(s) for this experiment', to='rawdata_catalog.Injection'),
        ),
        migrations.AddField(
            model_name='project',
            name='project_tag',
            field=models.ManyToManyField(help_text='Select project tag(s) for this experiment', to='rawdata_catalog.ProjectTag'),
        ),
    ]
