...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('rawdata_catalog', '0057_rename_data type_experiment_data_type'),
    ]
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name='publication',
            field=models.ManyToManyField(blank=True, help_text='Select publication(s) for this experiment', to='rawdata_catalog.Publication'),
        ),
    ]
