...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('rawdata_catalog', '0004_auto_20160921_1422'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='book',
            name='subject',
            field=models.ManyToManyField(help_text='Select a grouping category for this book', to='rawdata_catalog.Subject', verbose_name='Category'),
        ),
    ]
