...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('rawdata_catalog', '0078_auto_20230814_1219'),
    ]
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(default='', help_text='Select experimental samples for this experimental dataset', null=True, to='rawdata_catalog.ExperimentalSample'),
        ),
    ]
